...
Route::get('/pets/pet_form', [RegistrationController::class, 'createPetForm'])->name('create.pet_form'); //ペット新規登録
Route::post('/pets/pet_form', [RegistrationController::class, 'createPet'])->name('create.pet');
Route::get('/healths/health_form', [RegistrationController::class, 'createHealth'])->name('create.health'); //体調記録作成
